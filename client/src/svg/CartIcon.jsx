...
const CartIcon = (props) => {
    return <>
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="5.7 0 105.5 126.1"
             preserveAspectRatio="xMinYMax meet" data-hook="svg-icon-1" {...props}>
            <path
            ...
            <text x="58.5" y="77" dy=".35em" textAnchor="middle" className="_2u__n" data-hook="items-count">0</text>
        </svg>
    </>
}
